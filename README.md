...
NOTE: BareIronOperator only runs on UNIX/Linux terminals. It does not work on WSL due to the way networking works.
...
4. Run the command "ip a" in your terminal. Make note of your computer's new IP given to you from the router. It should be in the format 192.168.11.???
5. Run "nano BareIronOperator.py" (or your favorite text editor). Edit DEVICE_IP to the ip from instruction #4. Then, type Ctrl+X then y then enter
6. Run python3 BareIronOperator.py
